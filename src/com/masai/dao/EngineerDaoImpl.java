...
public class EngineerDaoImpl implements EngineerDao {
	...
	@Override
	public List<Complain> getListOfProblemAssignByHod() throws SomethingWentWrong {
		Connection conn = null;
	...
	@Override
	public String changeStatusOfComplain(int ticketNum, String status) throws SomethingWentWrong {
		Connection conn = null;
	...
	@Override
	public List<Complain> getListOfProblemAttendByEngineer() throws SomethingWentWrong {
		Connection conn = null;
		String engusername = eng.getEngUserName();
