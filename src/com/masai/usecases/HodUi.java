...
public class HodUi {
	...
	public boolean loginHodUi() throws SomethingWentWrong {
		System.out.println("Enter Username: ");
		String username = sc.next();
		System.out.println("Enter Password: ");
		String password = sc.next();
		boolean res = hd.loginHod(username, password);
		return res;
	}

	public void registerEngineerUi() throws SomethingWentWrong {
	...
	public void getAllRegisterEngineerUi() throws SomethingWentWrong {
		HodDao hd = new HodDaoImpl();
	...
	public void deleteEngineerUi() throws SomethingWentWrong {
	...
	public void getListOfAllComplainUi() throws SomethingWentWrong {
	...
	public void assigningProblemToEngineerUi() throws SomethingWentWrong {
